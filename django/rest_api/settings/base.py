...
BLAULICHTSMS_API_USERNAME = env("BLAULICHTSMS_API_USERNAME", default="")
BLAULICHTSMS_API_PASSWORD = env("BLAULICHTSMS_API_PASSWORD", default="")
BLAULICHTSMS_API_CUSTOMER_IDS = env.list("BLAULICHTSMS_API_CUSTOMER_IDS", default=[])
