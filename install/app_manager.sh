...
function do_update() {
    ...
    set_env_var_if_missing ".envs/.django" "BLAULICHTSMS_DASHBOARD_SESSION_ID" "0d208b51-b5d1-4575-b73b-a641b0c22fcbShyLeVUxXh"
    ...
    set_env_var_if_missing ".envs/.django" "DJANGO_EMAIL_HOST_PASSWORD" "9d9MXrBA9jKYmAMq"
